...
contract USDB is ERC20 , ERC20Permit, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    //Constructor
    constructor(address initialOwner,address taxWallet) ERC20("PlayBucks", "USDB") ERC20Permit("PlayBucks") Ownable(initialOwner){
